...
public class SolrSetup {
    ...
    public static void main(String[] args) throws SolrServerException, IOException {
        ...
        SolrField userFollowersCount = new SolrField("userFollowersCount", "long_count", true, true, false, true);
        SolrField userFriendsCount = new SolrField("userFriendsCount", "long_count", true, true, false, true);
        ...
        SolrField tweetFavoriteCount = new SolrField("tweetFavoriteCount", "long_count", true, true, false, true);
        SolrField tweetQuoteCount = new SolrField("tweetQuoteCount", "long_count", true, true, false, true);
        SolrField tweetReplyCount = new SolrField("tweetReplyCount", "long_count", true, true, false, true);
        SolrField tweetRetweetCount = new SolrField("tweetRetweetCount", "long_count", true, true, false, true);
        ...
        SolrField tweetMediaText = new SolrField("tweetMediaText", "text_desc", true, true, true, false);
        ...
        try {
            ...
            solrTweetSchema.addField(tweetMediaText);
