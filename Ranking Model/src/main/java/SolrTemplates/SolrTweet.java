...
public class SolrTweet {
    ...
    List<String> tweetMediaText;
    List<String> tweetAttachedLinks;

    public SolrTweet(String tweetID, String userID, String tweetDateTime, String tweetText, Long tweetFavoriteCount, Long tweetQuoteCount, Long tweetReplyCount, Long tweetRetweetCount, List<String> tweetHashtags, List<String> tweetUserMentions, List<String> tweetMediaURL, List<String> tweetMediaText, List<String> tweetAttachedLinks) {
        ...
        this.tweetMediaText = tweetMediaText;
    ...
    public List<String> getTweetMediaText() {
        return this.tweetMediaText;
    }

    @Field("tweetMediaText")
    protected void setTweetMediaText(List<String> tweetMediaText) {
        this.tweetMediaText = tweetMediaText;
    }
