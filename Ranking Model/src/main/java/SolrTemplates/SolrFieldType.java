...
public class SolrFieldType {
    ...
    static final HashMap<String, Object> typeClassMap = new HashMap<>() {{
    ...
    static final HashMap<String, Object> tokenizerClassMap = new HashMap<>() {{
    ...
    static final HashMap<String, Object> similarityClassMap = new HashMap<>() {{
